...
TMM_perf_fibre_10 = mds.TMmodel((perforate, fibre_10cm,))
...
z_perf_fibre_10      = TMM_perf_fibre_10.impedance(omega,kx=0.,ID=0,boundary_condition = 'fixed')
...
alpha_perf_fibre_10_alla  = TMM_perf_fibre_10.absorption_diffuse(omega,theta_max=np.pi/2,allard=True,signal = False)
Z0_perf_fibre_10 = TMM_perf_fibre_10.impedance_allard(omega,kx=0.,ID=0,boundary_condition = 'fixed',signal = False)
...
plt.figure(2)
plt.plot(omega,np.real(z_perf_fibre_10.ydata.flatten()),label='Re 10cm fibre')
plt.plot(omega,np.imag(z_perf_fibre_10.ydata.flatten()),label='Im 10cm fibre')
plt.plot(omega,np.real(Z0_perf_fibre_10),label='Re 10cm fibre Alla')
